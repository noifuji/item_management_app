...
<body>
 	<div class="header">
 		<h1 class="page-title">商品情報変更確認</h1>
	</div>
  ...
  <div class="choice">
   <form action="ProduceUpdateItemView.action" class="form_back" method="post">
     <input type="hidden" name="item_no" value="<%=item.getItemNo()%>">
     <input class="submit_button" type="submit" value="戻る">
   </form>
   <form action="UpdateItem.action" class="form_register" method="post">
